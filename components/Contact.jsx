    ...
    <div className="w-full lg:h-screen">
      <div className="max-w-[1240px] m-auto px-2 py-16 w-full">
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          {/* LEFT SIDE */}
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-md shadow-gray-400 rounded-xl p-2 bg-white">
            <div className="lg:p-2 h-full">
              ...
              <div>
                <h2 className="pt-4 pb-2 text-[#363537] text-center">Paige Nelmes</h2>
                <h4 className="text-[#5C6CFF] uppercase tracking-wider text-center">
                  Full Stack Developer
                </h4>
                <p className="text-[#363537] text-center py-4">
                  Open to freelance or full-time opportunities. <br /> Contact me and let&apos;s chat!
                </p>
              </div>
              <div>
              <div>
